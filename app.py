...
fastingbloodsugar = st.radio("Fasting Blood Sugar > 120 (fastingbloodsugar)", [0, 1],
horizontal=True)
...
if pred == 1: st.error("?? Heart Disease Detected")
else: st.success("? No Heart Disease Detected")
except KeyError as e:
st.error(f"Dataset column mismatch. Could not find column: {e}. Please ensure you are
using the correct Mendeley dataset.")
with tab2:
